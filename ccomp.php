        ...
        <div class="container" style="padding-left:10px">
            ...
            <table class="table table-hover" style="width:auto">
                ...
                <tbody>
                    ...
                    // Fetch complaints with action 'Closed'
                    $sql = "SELECT * FROM complaints WHERE action = 'Closed'";
                    ...
                    while ($complaint = mysqli_fetch_assoc($records)) {
                        ...
                        echo "<td>" . $complaint['username'] . "</td>";
                        echo "<td>" . $complaint['email'] . "</td>";
                        echo "<td>" . $complaint['category'] . "</td>";
                        echo "<td>" . $complaint['urgency'] . "</td>";
                        echo "<td>" . $complaint['date_of_complaint'] . "</td>";
                        echo "<td>" . $complaint['sitio'] . "</td>";
                        echo "<td>" . $complaint['description'] . "</td>";
                        echo "<td>" . ($complaint['file_path'] ? "<a href='" . $complaint['file_path'] . "' target='_blank'>View File</a>" : "No File") . "</td>";
                        echo "</tr>";
                    }
